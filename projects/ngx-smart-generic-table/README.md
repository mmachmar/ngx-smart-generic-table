...
|          [4.x.x](https://www.npmjs.com/package/ngx-smart-generic-table/v/4.0.1)           | 11.2.14            | 14.17.4  |
|          [5.x.x](https://www.npmjs.com/package/ngx-smart-generic-table/v/5.0.1)           | 12.2.12            | 14.17.4  |

## Installation

`$ npm install ngx-smart-generic-table --save`

### Add the dependencies according to the library version. For v5.0.1 version use the following in your package.json:
